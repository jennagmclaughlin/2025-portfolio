...
export const Navbar = () => {
  // nav build
  return (
    <nav className="left-0 right-0 md:container px-[12px] md:rounded-b-full fixed w-full m-auto z-[999] transition-all duration-300 py-[8px] md:py-[12px] bg-background-color md:bg-background-color/65 backdrop-blur-md shadow-xs">
